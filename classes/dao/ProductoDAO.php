...
class ProductoDAO {
    ...
    public static function listar() {
        ...
        $sql = "SELECT p.id, p.nombre, p.categorias_id, c.nombre AS categorias_nombre, descripcion, precio, stock, imagen_nombre, imagen_tipo, imagen_tamanio, creado, estado
                FROM productos p
    ...
    public static function registrar($producto) {
        ...
        $query = "INSERT INTO productos (categorias_id, nombre, descripcion, precio, stock, imagen_nombre, imagen_tipo, imagen_tamanio) "
        ...
        $stmt->bindParam(':imagen', $producto->imagen_nombre);
    ...
    public static function actualizar($producto) {
        ...
        if(isset($producto->imagen_nombre)){
            ...
            $query = "UPDATE productos SET imagen_nombre=:imagen_nombre, imagen_tipo=:imagen_tipo, imagen_tamanio=:imagen_tamanio "
                    . "WHERE id=:id";
